...
public class ProductController {
	...
	public String insertProduct(@ModelAttribute("product") Product product,
			@RequestParam("productimage") MultipartFile filedet, Model m) {
		...
		m.addAttribute("pageinfo", "Product");
		m.addAttribute("categoryList", this.getCategories());
		String imagepath = "C:\\Users\\patil\\Dropbox\\PC\\Desktop\\WEJE2\\springfrontend\\src\\main\\webapp\\resources\\image\\";
